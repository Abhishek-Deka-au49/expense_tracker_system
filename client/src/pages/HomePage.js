...
const HomePage = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      if (editable){
        ...
        await axios.post("http://localhost:8080/api/v1/transaction/add-transaction", {...values,userid: user._id});
      setLoading(false);
  ...
  return (
    ...
    <Modal
      ...
      footer={false}
    >
      <Form className='expenseForm' layout="vertical" onFinish={handleSubmit} initialValues={editable}>
